 ...
 */
export function thruAfter<TEvent extends any[], TReturn1>(
  pass1: (this: void, ...args: TEvent) => TReturn1,
): (this: void, input: AfterEvent<TEvent>) => AfterEvent<Out<TReturn1>>;

export function thruAfter<TEvent extends any[], TReturn1, TArgs2 extends Args<TReturn1>, TReturn2>(
  pass1: (this: void, ...args: TEvent) => TReturn1,
...
export function thruAfter<TEvent extends unknown[], TReturn extends unknown[]>(
  ...
  const map = (
    thruAfter_ as unknown as (
      ...passes: ((...args: unknown[]) => unknown)[]
    ) => (supplier: AfterEvent<TEvent>) => AfterEvent<TReturn>
  )(...passes);
 ...
 */
export function thruAfter_<TEvent extends any[], TReturn1>(
  pass1: (this: void, ...args: TEvent) => TReturn1,
): (this: void, input: AfterEvent<TEvent>) => AfterEvent<Out<TReturn1>>;

export function thruAfter_<TEvent extends any[], TReturn1, TArgs2 extends Args<TReturn1>, TReturn2>(
  pass1: (this: void, ...args: TEvent) => TReturn1,
  pass2: (this: void, ...args: TArgs2) => TReturn2,
): (this: void, input: AfterEvent<TEvent>) => AfterEvent<Out<TReturn2>>;

export function thruAfter_<
  TEvent extends any[],
  TReturn1,
  TArgs2 extends Args<TReturn1>,
  TReturn2,
...
export function thruAfter_<TEvent extends any[], TReturn extends any[]>(
  ...passes: ((...args: unknown[]) => unknown)[]
): (this: void, supplier: AfterEvent<TEvent>) => AfterEvent<TReturn> {
